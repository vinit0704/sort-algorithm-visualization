...
/* Canvas container that holds bars */
export const CanvasContainer = styled.div`
  display: flex;
  align-items: flex-end;
  height: calc(100vh - 80px); /* make room for toolbar (80px) */
  width: 100%;
  overflow-x: hidden;
`;
...
/* Bar: width & height will come from inline styles for exact control */
...
`;
/* rest of toolbar styles unchanged... */
